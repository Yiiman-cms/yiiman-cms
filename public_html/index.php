...
require realpath(__DIR__.'/../script/common/system.php');

require __DIR__ . '/../script/vendor/yiisoft/yii2/Yii.php';
require __DIR__ . '/../script/common/config/bootstrap.php';
require __DIR__ . '/../script/frontend/config/bootstrap.php';
...
$config = yii\helpers\ArrayHelper::merge(
    ...
    require __DIR__ . '/../script/frontend/config/main.php',
    require __DIR__ . '/../script/frontend/config/main-local.php'
);
